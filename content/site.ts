...
const en = {
  ...
  hero: {
    ...
    titleA: "Understand",
    titleB: "what you own",
    titleC: "— not just track it.",
    sub: "Every holding across every broker — stocks, ETFs, bonds, crypto and metals — with the real math behind each one and AI that explains what actually changed. Built for learning, not hype.",
  ...
  video: {
    eyebrow: "See it move",
    title: "A quick look inside Alpha Investor",
  ...
  pricing: {
    ...
    free: {
      ...
      features: [
        ...
        "Health score & AI insight previews",
      ],
      cta: "Join Early Access",
      ctaLaunched: "Download free",
    },
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Is Android coming?", a: "Alpha Investor is live on iOS. Android is on the roadmap — leave your email below to hear when it lands." },
    ],
  },
  finalCta: {
    title: "Start with your real portfolio",
    sub: "Download free on iOS — or leave your email for Android news and major releases.",
...
const pl: SiteContent = {
  ...
  hero: {
    ...
    titleA: "Zrozum,",
    titleB: "co naprawdę masz",
    titleC: "— nie tylko śledź.",
    sub: "Każda pozycja u każdego brokera — akcje, ETF-y, obligacje, krypto i metale — z prawdziwą matematyką za każdą z nich i AI, które tłumaczy, co się faktycznie zmieniło. Do nauki, nie do hype'u.",
  ...
  tour: {
    eyebrow: "Przewodnik",
    title: "Wszystko, czego potrzebuje Twój portfel — krok po kroku, ekran po ekranie.",
    sub: "Przewiń, żeby zobaczyć aplikację w akcji — od portfela w jednym miejscu po insighty AI, które łatwo zrozumieć.",
    steps: [
      {
        tag: "Portfel",
      ...
      {
        tag: "Alokacja",
        title: "Zobacz, jak naprawdę rozkłada się Twój portfel",
      ...
      },
      {
        ...
        body: "Jeden health score i wszystkie kluczowe KPI — P/L, wartość rynkowa, koszt nabycia, YTD — w walucie, którą znasz na co dzień.",
      },
      {
        tag: "Fundamenty",
        title: "Pełny profil każdego instrumentu",
        body: "Kapitalizacja, P/E, marże, dźwignia i stopa dywidendy — fundamenty stojące za każdą ceną, w jednym dotknięciu.",
      },
      {
        tag: "Wykres",
        title: "Każda cena, wykres i wskaźnik",
        body: "Pełna historia ceny z RSI i MACD tuż pod wykresem, plus prosty odczyt tego, co oznaczają — te same sygnały, których używają profesjonaliści.",
      },
    ],
  },
  features: {
    ...
    sub: "Śledź, rozumiej i ucz się na podstawie pieniędzy, które faktycznie posiadasz — niezależnie od brokera, waluty czy klasy aktywów.",
    cards: [
      { title: "Wiele portfeli w jednym miejscu", body: "Konta maklerskie, krypto i metale obok siebie, zsumowane w jeden widok majątku." },
      { title: "Pozycje z pełną historią", body: "Dodaj datę zakupu, koszt i opłaty — kursy podpowiadamy automatycznie, gdy mamy dane, a P/L liczymy na podstawie aktualnych notowań." },
      ...
      { title: "Wykresy historii wartości", body: "Wartość portfela od 1W do 5Y, odtworzona z księgi — gotówka i pozycje w czasie." },
  ...
  video: {
    ...
    title: "Krótkie spojrzenie na wnętrze Alpha Investor",
  ...
  gallery: {
    ...
    shots: [
      ...
      { src: "/marketing/screens/five-lenses.png", caption: "Pięć soczewek, dla każdej pozycji" },
  ...
  imports: {
    eyebrow: "Import w kilka minut",
    title: "Zacznij od portfela, który już masz",
    sub: "Wyeksportuj plik z brokera, a my automatycznie zmapujemy Twoje pozycje — bez podawania haseł do rachunku maklerskiego.",
    steps: [
      ...
      { title: "Analityka włączona", body: "Alokacja, wyniki, soczewki i insighty są dostępne od razu." },
    ],
  ...
  ai: {
    ...
    bullets: [
      "Insighty o realnej koncentracji i dywersyfikacji Twojego portfela",
      "Uzasadnienie każdej soczewki — z liczbami, dla każdej pozycji",
      "Wskazówki dotyczące alokacji, KPI i scenariuszy optymalizatora",
      "Dostęp do nowych funkcji premium przed innymi",
    ],
  ...
  pricing: {
    ...
    free: {
      ...
      features: [
        ...
        "Health score i podglądy insightów AI",
      ],
      cta: "Dołącz do Early Access",
      ctaLaunched: "Pobierz za darmo",
    },
    pro: {
      name: "Alpha Pro",
      price: "44,99 zł",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Czy będzie Android?", a: "Alpha Investor jest dostępny na iOS. Android jest w planach — zostaw e-mail poniżej, a damy znać, gdy wejdzie." },
    ],
  },
  finalCta: {
    title: "Zacznij od swojego realnego portfela",
    sub: "Pobierz za darmo na iOS — albo zostaw e-mail, by dostać wieści o Androidzie i najważniejszych nowościach.",
  ...
  showcase: {
    ...
    optimizer: {
      eyebrow: "Portfolio Optimizer",
      title: "Zobacz efekt, zanim podejmiesz decyzję",
      ...
      bullets: [
        "Krok po kroku, ilustracyjne scenariusze rebalansu",
    ...
    scanner: {
      ...
      title: "Uszereguj watchlistę po swojemu",
  ...
  footer: {
    ...
    company: "Prowadzone przez Jakuba Gruszczyka, QBKSHOP (NIP 6423222018).",
    cols: {
