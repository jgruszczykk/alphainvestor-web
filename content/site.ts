...
const pl: SiteContent = {
  ...
  hero: {
    ...
    titleB: "portfel inwestycyjny",
    titleC: "w jednym miejscu.",
    sub: "Zaimportuj dane z brokera, śledź każdy portfel i rozumiej, co się zmieniło — z licencjonowanymi danymi rynkowymi i AI stworzonym do nauki, nie do hype'u.",
  ...
  finalCta: {
    ...
    sub: "Dołącz do early access — dowiesz się jako pierwszy o terminie startu, wersji na Androida i najważniejszych nowościach.",
